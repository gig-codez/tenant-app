                      ...
                      CommonButton(
                        ...
                        onTap: () {
                          if (options == "" || options.isEmpty) {
                            ...
                            //     "POST", Uri.parse(Feeds.addComplaint));
                            // request.fields['name'] = options == 'Others'
                            //     ? _titleController.text
                            //     : options;
                            // request.fields["tenant"] = context
                            //     .read<UserAccountController>()
                            //     .state
                            //     .userId;
                            // request.fields['property'] = context
                            ...
                            //   MultipartFile(
                            //     "image",
                            //     _byteImage!.cast<List<int>>(),
                            //     File(_base64Image!).lengthSync(),
                            //     filename: File(_base64Image!)
                            //         .path
                            //         .split("/")
                            //         .last,
                            //   ),
